...
export class ClasslistPage implements OnInit {
 ...
 async createClass(){
  ...
  // createActionBtn(){
  //   let actionBtn = [];
  //   if(this.userType == '1' && !this.editMode && this.showIcon){
  //     actionBtn.push({text: 'Edit', icon: 'pencil-sharp', handler: () => { this.enableEditMode(); } });
  //   }
  //   if(this.userType == '1' && this.showIcon){
  //     actionBtn.push({text: 'Add class', icon: 'add-circle-outline', handler: () => { this.createClass(); } });
  //   }
  //   if(this.showIcon){
  //     actionBtn.push({text: 'Search', icon: 'search', handler: () => { this.openSearchPage(); } });
  //   }
  //   if(this.canReorder  && this.showIcon){
  //     actionBtn.push({text: 'Reorder Class', icon: 'swap-vertical-outline', handler: () => { this.toogleReorder(); } });
  //   }
  //   return actionBtn;
  // }
}
