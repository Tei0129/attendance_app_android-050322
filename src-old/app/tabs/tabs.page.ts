...
export class TabsPage implements OnInit {
  ...
  hide_new: any;
  constructor(public dbProvider: DatabaseService,private authProvider:AuthService, private dataProvider: DataService) { 
    this.authProvider.event.subscribe(res=>{
      ...
      //  http://basmapp.com/Att-App/app_service_new/newsSectionHideShow

       this.dataProvider.newsSectionHideShow('newsSectionHideShow').then(res =>{
         console.log(res);
        //  this.hide_new = res.app_setting.hide_news;
       })
