...
let ListStudentPage = /** @class */ (() => {
    let ListStudentPage = class ListStudentPage {
        ...
        */
         ...
         * @param sem semeseter
         */
        changeAttendanceStatus(student, sem) {
        ...
        submitAttendance() {
            if (this.teacher_type && this.teacher_type == 'regular') {
                if (this.checkAttendence()) {
                    if (this.attMarked || ((Object.keys(this.attendanceSheet).length > 0 || Object.keys(this.removeSheet).length > 0) && this.userType == '1')) {
                        this.dataProvider.showLoading();
                        let data = {};
...
export { ListStudentPage };
//# sourceMappingURL=list-student.page.js.map