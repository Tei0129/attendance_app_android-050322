  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function Y5(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
         ...
         */
        function LoginPage(navCtrl, device, authProvider, dataProvider, platform, fcm, translate, route, popoverController, zone, router, dbProvider) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            if (this.platform.is("cordova")) {
              ...
              this.fcm.getToken().then(function (token) {
                _this.user.registration_id = token;
              });
            }

            this.dataProvider.getAds().then(function (response) {
              if (response && response.ads) {
                var ads = response.ads;

                if (ads.length > 0 && ads.left.medias && ads.left.medias.length > 0) {
                  _this.topLeftAd = ads.left.medias[0].url;
                  _this.topRightAd = ads.right.medias[0].url;
                  _this.bottomAds = ads.bottom.medias;
                } else {
                  _this.dissmissPopOver();
                }
              }
            });
          }
          ...
          key: "loginOldUser",
          value: function loginOldUser(oldUser) {
          ...
          value: function login() {
            ...
            this.authProvider.doLogin(this.user).then(function (response) {
              ...
              if (_this2.loggedinUser.length > 0) {
                var isexist = false;
                var index;

                for (var i = 0; i < _this2.loggedinUser.length; i++) {
                  if (_this2.loggedinUser[i].email_id == _this2.user.email_id) {
                    isexist = true;
                    index = i;
                  }
                }
                ...
                if (!isexist) {
                  _this2.loggedinUser.push(data);
                } else {
                  _this2.loggedinUser[index] = data;
                }

                console.log('early Log', _this2.loggedinUser);
                localStorage.setItem("earlyLogin", JSON.stringify(_this2.loggedinUser));
              } else {
                var _img;
                ...
                _this2.loggedinUser.push(_data);

                console.log('early Log', _this2.loggedinUser);
                localStorage.setItem("earlyLogin", JSON.stringify(_this2.loggedinUser));
              }

              _this2.authProvider.publishEvent(true);

              _this2.authProvider.changeUser(true);

              if (response.details.user_type == '4') {
                _this2.router.navigate(['tabs/children'], {
                  replaceUrl: true
                });
              } else if (response.details.user_type == '8') {
                _this2.router.navigate(['tabs/student-notes'], {
                  replaceUrl: true
                });
              } else {
          ...
          value: function forgotPassword() {
            ...
            this.zone.run(function () {
              _this3.router.navigate(['forgot-password'], navigation);
            });
          }
        }, {
          key: "presentPopover",
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _ionic_native_device_ngx__WEBPACK_IMPORTED_MODULE_8__["Device"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _service_data_data_service__WEBPACK_IMPORTED_MODULE_6__["DataService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_9__["FCM"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_10__["TranslateService"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["ActivatedRoute"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["PopoverController"], _angular_core__WEBPACK_IMPORTED_MODULE_3__["NgZone"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["Router"], _service_database_database_service__WEBPACK_IMPORTED_MODULE_7__["DatabaseService"]])], LoginPage);
      /***/
    },
