(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-teacher-add-teacher-module"], {
    ...
    function bF(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "AddTeacherPage", function () {
      ...
      var _raw_loader_add_teacher_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./add-teacher.page.html */
      "T2ey");
      /* harmony import */


      var _add_teacher_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./add-teacher.page.scss */
      "lYDd");
      /* harmony import */
      ...
      var AddTeacherPage = /*#__PURE__*/function () {
        function AddTeacherPage(navCtrl, translate, dataProvider, authProvider, alertCtrl, route, zone, router, modalController) {
          var _this = this;

          _classCallCheck(this, AddTeacherPage);
          ...
          this.translate.get("alertmessages").subscribe(function (res) {
            _this.lang = res; //console.log('langres',res);
          });
        }

        _createClass(AddTeacherPage, [{
          key: "ngOnInit",
          ...
          value: function submit() {
            ...
            if (this.validateForm()) {
              ...
              this.dataProvider.registerTeacher(this.teacherData).then(function (res) {
      ...
      AddTeacherPage.ctorParameters = function () {
        return [{
      ...
      AddTeacherPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function T2ey(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function lYDd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function oSRS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddTeacherPageRoutingModule", function () {
        return AddTeacherPageRoutingModule;
      });
      /* harmony import */
      ...
      var _add_teacher_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./add-teacher.page */
      "6+bF");
      ...
      var AddTeacherPageRoutingModule = function AddTeacherPageRoutingModule() {
        _classCallCheck(this, AddTeacherPageRoutingModule);
      };

      AddTeacherPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function veIr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddTeacherPageModule", function () {
      ...
      var _add_teacher_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./add-teacher-routing.module */
      "oSRS");
      /* harmony import */


      var _add_teacher_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./add-teacher.page */
      "6+bF");
      /* harmony import */
      ...
      var AddTeacherPageModule = function AddTeacherPageModule() {
        _classCallCheck(this, AddTeacherPageModule);
      };

      AddTeacherPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _add_teacher_routing_module__WEBPACK_IMPORTED_MODULE_5__["AddTeacherPageRoutingModule"]],
...
//# sourceMappingURL=add-teacher-add-teacher-module-es5.js.map