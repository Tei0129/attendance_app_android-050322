(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["followup-student-list-followup-student-list-module"], {
    ...
    function uI6l(module, __webpack_exports__, __webpack_require__) {
      ...
      "TgDs"); //import { TabsPage } from '../tabs/tabs';


      var FollowupStudentListPage = /*#__PURE__*/function () {
        function FollowupStudentListPage(navCtrl, dataProvider, authProvider, translate, alertCtrl, camera, network, route, router, printer, studentService, zone, platform) {
          var _this = this;
        ...
        _createClass(FollowupStudentListPage, [{
          ...
          key: "openNoteModal",
          value: function openNoteModal(student) {
              ...
              if (this.noteMessage.length <= 45) {
                if (this.canAddStudentNote) {
                  ...
                  this.dataProvider.addStudentNote(data).then(function (note_id) {
                    ...
                    console.log("course id", _this14.navData.cid);
                    var state = {
                      course: _this14.navData
                    };
                    _this14.noteMessage = '';
                    _this14.showNoteModal = false; // this.router.navigate(['student-detail'],{state: sendWith});

                    _this14.dataProvider.showToast("note has been submitted");

                    _this14.router.navigate(['followup-student-list'], {
                      state: state
                    });
                  })["catch"](function (error) {
