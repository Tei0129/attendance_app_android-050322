(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["share-bulletins-share-bulletins-module"], {
    ...
    /***/
    function PPT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ShareBulletinsPageModule", function () {
      ...
      var _share_bulletins_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./share-bulletins-routing.module */
      "VgP3");
      /* harmony import */


      var _share_bulletins_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./share-bulletins.page */
      "d2gO");
      /* harmony import */
      ...
      var ShareBulletinsPageModule = function ShareBulletinsPageModule() {
        _classCallCheck(this, ShareBulletinsPageModule);
      };

      ShareBulletinsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _share_bulletins_routing_module__WEBPACK_IMPORTED_MODULE_5__["ShareBulletinsPageRoutingModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]],
    ...
    /***/
    function VgP3(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ShareBulletinsPageRoutingModule", function () {
      ...
      var _share_bulletins_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./share-bulletins.page */
      "d2gO");
      ...
      var ShareBulletinsPageRoutingModule = function ShareBulletinsPageRoutingModule() {
        _classCallCheck(this, ShareBulletinsPageRoutingModule);
      };

      ShareBulletinsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function d2gO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ShareBulletinsPage", function () {
      ...
      var _raw_loader_share_bulletins_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./share-bulletins.page.html */
      "iB6S");
      /* harmony import */


      var _share_bulletins_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./share-bulletins.page.scss */
      "idCA");
      /* harmony import */
      ...
      var _ionic_native_document_scanner_ngx___WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! @ionic-native/document-scanner/ngx/ */
      "Vj9j");

      var ShareBulletinsPage = /*#__PURE__*/function () {
        function ShareBulletinsPage(navCtrl, dataProvider, authProvider, translate, alertCtrl, network, route, router, documentScanner, zone, platform) {
          var _this = this;

          _classCallCheck(this, ShareBulletinsPage);
          ...
          this.route.queryParams.subscribe(function (params) {
            if (_this.router.getCurrentNavigation().extras.state) {
              ...
              _this.bulletin = _this.router.getCurrentNavigation().extras.state.bulletin;
              _this.forward_user_no = _this.router.getCurrentNavigation().extras.state.forward_user_no;
              _this.school_id = _this.router.getCurrentNavigation().extras.state.school_id;
              console.log(_this.navData);
            }
          });
        }

        _createClass(ShareBulletinsPage, [{
          key: "share",
          value: function share() {
            ...
            this.zone.run(function () {
              _this2.router.navigate(['select-bulletins-user'], navigation);
            });
          }
        }, {
          key: "ngOnInit",
      ...
      ShareBulletinsPage.ctorParameters = function () {
        return [{
      ...
      ShareBulletinsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function iB6S(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function idCA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=share-bulletins-share-bulletins-module-es5.js.map