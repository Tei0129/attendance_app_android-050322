(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["school-registration-school-registration-module"], {
    ...
    /***/
    function AVMY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function eLfT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SchoolRegistrationPage", function () {
      ...
      var _raw_loader_school_registration_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./school-registration.page.html */
      "30KU");
      /* harmony import */


      var _school_registration_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./school-registration.page.scss */
      "AVMY");
      /* harmony import */
      ...
      var _service_location_location_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var _service_geo_service_geo_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../service/geo-service/geo-service */
      "G+rw");

      var SchoolRegistrationPage = /*#__PURE__*/function () {
        function SchoolRegistrationPage(navCtrl, camera, alertCtrl, translate, geo, dataProvider, authProvider, locationSrevice, router) {
          var _this = this;

          _classCallCheck(this, SchoolRegistrationPage);
        ...
        _createClass(SchoolRegistrationPage, [{
          key: "ngOnInit",
          ...
          value: function getLocation() {
            ...
            console.log('call'); // this.locationSrevice.checkGPSPermission(resp=>{
            //   this.location=resp;
            ...
            this.geo.getMyLocation().then(function (resp) {
              ...
              if (resp != '') {
                _this2.location = resp;
                console.log('page', _this2.location);
                _this2.countryName = resp.countryname;
                _this2.countryCode = resp.countrycode;
              } else {
                console.log(resp);
              }
            });
          ...
          key: "takePicture",
          value: function takePicture(imageType) {
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this3.openCamera(imageType);
                          }
                        }, {
                          text: this.lang.gallery,
                          handler: function handler() {
                            _this3.openGallery(imageType);
                          }
                        }]
                      });
          ...
          key: "openCamera",
          value: function openCamera(imageType) {
            var _this4 = this;
            ...
            this.camera.getPicture(options).then(function (imageData) {
              if (imageData) {
                if (imageType == 'schoollogo') {
                  _this4.school.school_logo = 'data:image/png;base64,' + imageData;
                  _this4.school_logo = 'data:image/png;base64,' + imageData;
                } else {
                  _this4.school.school_image = 'data:image/png;base64,' + imageData;
                  _this4.school_image = 'data:image/png;base64,' + imageData;
                }
              }
            });
          }
          ...
          key: "openGallery",
          value: function openGallery(imageType) {
            var _this5 = this;
            ...
            this.camera.getPicture(options).then(function (imageData) {
              if (imageData) {
                if (imageType == 'schoollogo') {
                  _this5.school.school_logo = 'data:image/png;base64,' + imageData;
                  _this5.school_logo = 'data:image/png;base64,' + imageData;
                } else {
                  _this5.school.school_image = 'data:image/png;base64,' + imageData;
                  _this5.school_image = 'data:image/png;base64,' + imageData;
                }
              }
            });
          }
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      this.authProvider.registerSchool(this.school).then(function (response) {
                        _this6.dataProvider.hideLoading();

                        _this6.presentAlert(response);
                      })["catch"](function (err) {
                        _this6.dataProvider.hideLoading();

                        _this6.dataProvider.errorALertMessage(err);
                      });
          ...
          key: "presentAlert",
          value: function presentAlert(response) {
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      _context3.next = 2;
                      return this.dataProvider.alertCtrl.create({
                        header: "Message",
                        message: response,
                        buttons: [{
                          text: 'Ok',
      ...
      SchoolRegistrationPage.ctorParameters = function () {
        return [{
      ...
      SchoolRegistrationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_8__["Camera"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_9__["TranslateService"], _service_geo_service_geo_service__WEBPACK_IMPORTED_MODULE_11__["GeoServiceProvider"], _service_data_data_service__WEBPACK_IMPORTED_MODULE_6__["DataService"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _service_location_location_service__WEBPACK_IMPORTED_MODULE_7__["LocationService"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"]])], SchoolRegistrationPage);
      /***/
    },
    ...
    /***/
    function v2GW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SchoolRegistrationPageModule", function () {
      ...
      var _school_registration_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./school-registration-routing.module */
      "x47w");
      /* harmony import */


      var _school_registration_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var SchoolRegistrationPageModule = function SchoolRegistrationPageModule() {
        _classCallCheck(this, SchoolRegistrationPageModule);
      };

      SchoolRegistrationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _school_registration_routing_module__WEBPACK_IMPORTED_MODULE_5__["SchoolRegistrationPageRoutingModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]],
    ...
    /***/
    function x47w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SchoolRegistrationPageRoutingModule", function () {
      ...
      var _school_registration_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./school-registration.page */
      "eLfT");
      ...
      var SchoolRegistrationPageRoutingModule = function SchoolRegistrationPageRoutingModule() {
        _classCallCheck(this, SchoolRegistrationPageRoutingModule);
      };

      SchoolRegistrationPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=school-registration-school-registration-module-es5.js.map