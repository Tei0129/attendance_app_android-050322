        ...
        _createClass(SettingsPage, [{
          ...
          value: function deleteSchool() {
            ...
            this.dataProvider.deleteSchoolSettings(data).then(function (response) {
              _this5.dataProvider.hideLoading(); // if(response.session){


              console.log(response);

              _this5.dataProvider.errorALertMessage(response.msg);

              _this5.deactivate_date = response.deactive_date; // this.router.navigate(['login'], { replaceUrl: true });
              // }
            })["catch"](function (error) {
              _this5.dataProvider.hideLoading();

              _this5.dataProvider.errorALertMessage(error.msg);
            });
          }
        }, {
          ...
          value: function revertSchoolDeletion() {
            ...
            this.dataProvider.revertDeletedSchoolSettings(data).then(function (response) {
              ...
              _this6.deactivate_date = ''; // this.deactivate_date = response.response.deactivate_date;
          ...
          value: function openCamera() {
            ...
            this.camera.getPicture(options).then(function (imageData) {
              if (imageData) {
                ...
                _this8.displayPic = 'data:image/png;base64,' + imageData;
                _this8.user.pic = 'data:image/png;base64,' + imageData;
              }
            });
          }
          /**
