  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["list-student-list-student-module"], {
    ...
    function QY(module, __webpack_exports__, __webpack_require__) {
      ...
      var ListStudentPage = /*#__PURE__*/function () {
         ...
         */
        function ListStudentPage(navCtrl, dataProvider, authProvider, translate, alertCtrl, camera, network, route, router, zone, modalController, platform) {
          var _this = this;
              ...
              if (this.noteMessage.length <= 45) {
                if (this.canAddStudentNote) {
                  ...
                  this.dataProvider.addStudentNote(data).then(function (note_id) {
                    ...
                    console.log("course id", _this19.navData.cid);
                    var sendWith = {
                      student_id: _this19.studentData.sid,
                      course_id: _this19.navData.cid,
                      dateSelected: _this19.dateSelected
                    };
                    _this19.noteMessage = '';
                    _this19.showNoteModal = false;

                    _this19.dataProvider.showToast('note has been submitted');

                    _this19.router.navigate(['list-student']);
                  })["catch"](function (error) {
                    console.log("erreremsg", error);

                    _this19.dataProvider.hideLoading();

                    _this19.dataProvider.errorALertMessage(error);
                  });
                } else {
