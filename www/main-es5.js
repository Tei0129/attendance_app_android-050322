          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              ...
              if (_this36.platform.is('ios')) {
                var w = window; // w.FCMPlugin.requestPushPermissionIOS(() => {
        ...
        _createClass(DataService, [{
          ...
          */
          ...
          value: function deleteStudent(data, callback) {
            ...
            this.postRequest(data, 'deleteStudent').then(function (response) {
              if (response) {
                _this60.showToast(_this60.lang.delete_student_success_msg);
          ...
          value: function updateStudentProfile(data, callback) {
            ...
            this.postRequest(data, 'updateStudentProfile').then(function (response) {
              if (response) {
                ...
                _this65.showToast(_this65.lang.edit_student_success_msg);
              }
            })["catch"](function (error) {
              console.log(error); //this.showToast(response.message);
            });
          ...
          */
          ...
          value: function printAllClassNotes(data) {
            ...
            return new Promise(function (resolve, reject) {
              // console.log(data);
              _this81.postRequest(data, data.is_multi ? 'printMultipleClassNotes' : 'printClassNotes').then(function (response) {
          ...
          */
          ...
          value: function getStudentReport(data) {
            var _this145 = this;

            return new Promise(function (resolve, reject) {
              _this145.postRequest(data, 'student_report_new_excel').then(function (response) {
                if (response.response) {
                  resolve({
                    session: true,
                    data: response.response
          ...
          */
          ...
          value: function getDelayClassStudentList(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this146.postRequest(data, 'getStudents_delay/' + data.course_id).then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
                    ...
                    _this146.dbProvider.insertStudentList(response.students, response.delay_rule);
                  ...
                  if (localStorage.getItem("delayclasslocalatt")) {
                    ...
                    if (attendance[data.course_id]) {
                      ...
                      _this146.dbProvider.getStudentList(data.course_id).then(function (students) {
          ...
          */
          ...
          value: function getStudentDetails(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this147.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  _this147.postRequest(data, 'viewStudent/' + data.sid).then(function (response) {
                    if (response) {
                      if (!response.session) {
                        reject(response.msg);
                      } else if (response.success) {
          ...
          */
          ...
          value: function getStudentNotes(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this148.postRequest(data, 'getStudentNote/' + data.sid).then(function (response) {
                if (response) {
                  if (response.status) {
                    resolve(response);
                  } else {
                  ...
                  reject(_this148.lang.networkNotWorking);
                }
              })["catch"](function (error) {
                console.log(error);
          ...
          value: function createNotes(data) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              _this149.httpClient.post(env.serverURL + 'createNotes', body, {
                headers: header
              }).subscribe(function (response) {
                if (response) {
                  console.log('tescherList', response);
          ...
          value: function getClassNotes(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this150.postRequest(data, 'studentClassNotes').then(function (response) {
                if (response) {
                  if (response.response) {
          ...
          value: function getAllClassNotes(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this151.postRequest(data, 'all_classNotes').then(function (response) {
                if (response) {
                  if (response.response) {
                    resolve(response.response);
                  } else {
          ...
          value: function getAllWarning(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this152.postRequest(data, 'getWarningReport').then(function (response) {
                if (response) {
                  if (response.response) {
                    resolve(response.response);
                  } else {
          ...
          value: function printWarning(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this153.postRequest(data, 'getWarningReportPdf').then(function (response) {
                if (response) {
                  if (response.response) {
                    resolve(response.response);
                  } else {
                  ...
                  reject(_this153.lang.networkNotWorking);
                }
              })["catch"](function (error) {
                console.log(error);
          ...
          value: function getNotifications(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this154.postRequest(data, 'getNotifications/' + data.school_id).then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
                    ...
                    _this154.dbProvider.insertPrivateMessages(response.list);
                  ...
                  _this154.dbProvider.getPrivateMessages().then(function (messages) {
                    resolve({
                      session: true,
                      data: messages
                    });
          ...
          value: function deleteNotification(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this155.postRequest(data, 'deleteNotifications').then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
            ...
            return new Promise(function (resolve, reject) {
              _this156.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  ...
                  _this156.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'saveAttendance/' + data.school_id, body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
            ...
            return new Promise(function (resolve, reject) {
              _this157.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  ...
                  _this157.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'saveStudentMarks/' + data.school_id, body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
          ...
          */
          ...
          value: function markDelayAttendance(data, submittedByUser) {
            ...
            return new Promise(function (resolve, reject) {
              _this158.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  data.lang_code = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].lang_code;
                  var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                  header.append('Content-Type', 'application/x-www-form-urlencoded');
                  ...
                  _this158.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'ManroxTesting2/' + data.school_id + '/' + submittedByUser, body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
          ...
          value: function saveAbsenceNote(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this159.postRequest(data, 'saveNote').then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
          ...
          value: function deleteAbsenceNote(data, note_id) {
            ...
            return new Promise(function (resolve, reject) {
              _this160.postRequest(data, 'deleteNote/' + note_id).then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
          ...
          value: function addStudentNote(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this161.postRequest(data, 'addStudentNote').then(function (response) {
                if (response) {
                  if (response.success) {
          ...
          value: function updateUserImage(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this162.postRequest(data, 'updateStudentImage/' + data.sid).then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
                  ...
                  reject(_this162.lang.networkNotWorking);
                }
              })["catch"](function (error) {
                console.log(error);
                ...
                if (error.message != undefined && error.message != '' && error.message != null) {
                  ...
                  reject(_this162.lang.usnexpectedError);
                }
              });
            });
          }
          ...
          value: function sendMessage(data, school_id) {
            ...
            return this.http.request(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["map"])(function (event) {
              return _this164.getStatusMessage(event);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["tap"])(function (message) {
              return message;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["last"])());
            ...
            return new Promise(function (resolve, reject) {
              _this165.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  ...
                  _this165.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'postNews', body, {
                    headers: header
                  }).subscribe(function () {
                    resolve(true);
                  }, function (error) {
            ...
            return new Promise(function (resolve, reject) {
              _this166.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  ...
                  _this166.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'saveUser', body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
            ...
            return new Promise(function (resolve, reject) {
              _this167.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  ...
                  _this167.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'deleteSchool', body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
          ...
          value: function revertDeletedSchoolSettings(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this168.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  data.lang_code = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].lang_code;
                  var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                  header.append('Content-Type', 'application/x-www-form-urlencoded');

                  var body = _this168.makeObjectToUrlParams(data);
                  ...
                  _this168.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'revertDeleteSchool', body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
                  ...
                  reject(_this168.lang.networkNotWorking);
                }
              });
            });
          }
          ...
          value: function getConnectChatList(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this169.postRequest(data, 'getParentConnectChatList').then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
                    ...
                    _this169.dbProvider.insertParentConnectMessages(response.chat_list);
                  ...
                  _this169.dbProvider.getParentConnectMessages().then(function (messages) {
                    resolve({
                      session: true,
                      chatList: messages
                    });
          ...
          value: function createParentConnectChat(data) {
            ...
            console.log(data);
            return new Promise(function (resolve, reject) {
              _this170.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  data.lang_code = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].lang_code;
                  var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                  header.append('Content-Type', 'application/x-www-form-urlencoded');
                  ...
                  _this170.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'createParentConnectChat', body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
          ...
          value: function closeParentConnectChat(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this171.postRequest(data, 'closeParentConnectChat').then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
          ...
          value: function reopenParentConnectChat(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this172.postRequest(data, 'reopenParentConnectChat').then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
          ...
          value: function getParentConnectChatMessages(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this173.postRequest(data, 'getParentConnectChatMessages').then(function (response) {
                if (response) {
                  if (!response.session) {
                    resolve({
                      session: false,
          ...
          value: function sendParentConnectChatMsg(data) {
            ...
            // console.log(data);
            return new Promise(function (resolve, reject) {
              _this174.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  data.lang_code = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].lang_code;
                  var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                  header.append('Content-Type', 'application/x-www-form-urlencoded');
                  ...
                  _this174.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'sendParentConnectChatMessage', body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
          ...
          value: function sendContact(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this175.postRequest(data, 'sendcontact').then(function (response) {
                if (response) {
                  if (response.success) {
                    resolve(true);
                  } else {
          ...
          */
          ...
          value: function deleteStudentNote(data, note_id) {
            ...
            return new Promise(function (resolve, reject) {
              _this176.postRequest(data, 'deleteStudentNote/' + note_id).then(function (response) {
                if (response) {
                  if (response.success) {
                    resolve(true);
                  } else {
                  ...
                  reject(_this176.lang.networkNotWorking);
                }
              })["catch"](function (error) {
                console.log(error);
                ...
                if (error.message != undefined && error.message != '' && error.message != null) {
                  ...
                  reject(_this176.lang.usnexpectedError);
                }
              });
            });
          }
                ...
                if (isNetworkAvailable) {
                  if (localStorage.getItem("attendance")) {
                    ...
                    attendances.forEach(function (attendance) {
                      promises.push(_this177.markOfflineAttendance(attendance));
                    });
                    Promise.all(promises).then(function (res) {
                      _this177.showToast('Attendance Synced successfully');
                  ...
                  if (localStorage.getItem("delayattendance")) {
                    ...
                    delayAttendances.forEach(function (delayAttendance) {
                      delayPromises.push(_this177.markOfflineDelayAttendance(delayAttendance.attendance, delayAttendance.submittedByUser));
                    });
                    Promise.all(delayPromises).then(function (res) {
                      _this177.showToast('Delay Attendance Synced successfully');
            ...
            return new Promise(function (resolve, reject) {
              _this178.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  ...
                  _this178.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'saveOfflineAttendance/' + data.school_id, body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
          ...
          value: function markOfflineDelayAttendance(data, submittedByUser) {
            ...
            return new Promise(function (resolve, reject) {
              _this179.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  data.lang_code = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].lang_code;
                  var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                  header.append('Content-Type', 'application/x-www-form-urlencoded');
                  ...
                  _this179.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + 'saveOfflineDelayAttendance/' + data.school_id + '/' + submittedByUser, body, {
                    headers: header
                  }).subscribe(function (res) {
                    var response = res;
                  ...
                  reject(_this179.lang.networkNotWorking);
                }
              });
            });
          }
          ...
          value: function getChildrens(data) {
            ...
            return new Promise(function (resolve, reject) {
              _this180.postRequest(data, 'getChildrens').then(function (response) {
                if (response) {
                  if (response.success) {
                    resolve({
                      data: response.child,
                ...
                if (error.message != undefined && error.message != '' && error.message != null) {
                  ...
                  reject(_this180.lang.usnexpectedError);
                }
              });
            });
          }
          ...
          value: function postRequest(data, slug) {
            ...
            return new Promise(function (resolve, reject) {
              _this181.getNetworkInformation().then(function (isNetworkAvailable) {
                if (isNetworkAvailable) {
                  var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
                  data.lang_code = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].lang_code;

                  var body = _this181.makeObjectToUrlParams(data);

                  header.append('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');

                  _this181.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + slug, body, {
                    headers: header
                  }).subscribe(function (response) {
                    if (response) {
                      if (response['_body'] != '') {
          ...
          */
          ...
          value: function getNetworkInformation() {
            ...
            return new Promise(function (resolve) {
              if (_this182.platform.is('cordova')) {
                if (_this182.network.type == _this182.network.Connection.UNKNOWN || _this182.network.type == _this182.network.Connection.NONE) {
                  resolve(false);
                } else {
                  resolve(true);
                }
          ...
          value: function downloadImage(url) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var fileTransfer = _this183.transfer.create();

              if (_this183.platform.is('ios')) {
                var targetPath = _this183.file.dataDirectory + "Download/" + n + ".png"; //this.cordova.file.dataDirectory
                ...
                fileTransfer.download(encodeURI(url), targetPath, true).then(function (entry) {
                  ...
                  reject(_this183.lang.usnexpectedError);
                  console.log("download error source " + error.source);
                  console.log("download error target " + error.target);
                  console.log("upload error code" + error.code);
                });
              } else {
                var _targetPath = _this183.file.externalRootDirectory + "Download/" + n + ".png"; //this.cordova.file.dataDirectory
          ...
          value: function checkStoragePermission() {
            ...
            return new Promise(function (resolve) {
              ...
              //   resolve(false);
              // })
              _this184.diagnostic.requestExternalStorageAuthorization().then(function () {
