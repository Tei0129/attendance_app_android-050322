(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["student-detail-student-detail-module"], {
    ...
    function MLlQ(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ionic_native_printer_ngx__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      ...
      var StudentDetailPage = /*#__PURE__*/function () {
        ...
        translate, alertCtrl, printer, camera, network, route, router, zone, popover, platform, storage, modalController, actionSheetController, subscription) {
          var _this = this;
        ...
        _createClass(StudentDetailPage, [{
            ...
            if (this.noteMessage && this.noteMessage.trim() != '') {
              if (this.noteMessage.length <= 45) {
                if (this.canAddStudentNote) {
                  ...
                  this.dataProvider.addStudentNote(data).then(function (note_id) {
                    _this10.dataProvider.hideLoading();

                    _this10.getNotes();

                    _this10.noteMessage = '';
                    _this10.showNoteModal = false;
                  })["catch"](function (error) {
                    _this10.dataProvider.hideLoading();
                    ...
                    case 0:
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this11.deleteUserNote(note_id, index);
                          }
                        }, {
          ...
          value: function udateNotes(data, note_id) {
            ...
            this.dataProvider.editAbsentNotes(updates).then(function (res) {
              ...
              if (res) {
                _this12.dataProvider.showToast(res.data.msg);
              ...
              _this12.dataProvider.showToast(err.message);
            });
          }
        }, {
          key: "deleteUserNote",
                    ...
                    case 0:
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          text: this.lang.yes,
                          handler: function handler() {
                            _this13.dataProvider.showLoading();

                            var data = {
                              user_no: _this13.userDetails.details.user_no,
                              session_id: _this13.userDetails.session_id
                            };

                            _this13.dataProvider.deleteStudentNote(data, note_id).then(function (response) {
                              _this13.canAddStudentNote = true;
            ...
            this.camera.getPicture(options).then(function (imageData) {
              if (imageData) {
                ...
                var data = {
                  ...
                  session_id: _this16.userDetails.session_id,
                  imageData: 'data:image/png;base64,' + imageData,
                  sid: _this16.navData.student_id
                };

                _this16.dataProvider.updateUserImage(data).then(function (response) {
                  _this16.dataProvider.hideLoading();

                  if (response.session) {
                    _this16.studentDetails.pic = response.url;
                  } else {
                    _this16.authProvider.flushLocalStorage();

                    _this16.dataProvider.errorALertMessage(response.message); // this.app.getRootNav().setRoot("LoginPage");
          ...
          value: function presentNoteActionSheet(mode, note, note_id) {
                    ...
                    case 0:
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          text: 'Student Review',
                          handler: function handler() {
                            _this17.openNoteModal('review', mode, note, note_id);
                          }
                        }, {
                          text: 'Student Note',
                          handler: function handler() {
                            _this17.openNoteModal('note', mode, note, note_id);
                          }
                        }, {
                          text: 'Cancel',
                          role: 'cancel',
          ...
          key: "openNoteModal",
          value: function openNoteModal(mode, note_mode, note, note_id) {
                  ...
                  switch (_context8.prev = _context8.next) {
                    ...
                    case 8:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        ...
                        if (data.data.data) {
                          _this18.ratingStars = data.data.data;
                          _this18.noteMessage = data.data.noteMessage;

                          if (note_mode === 'edit') {
                            _this18.udateNotes(data.data, note_id);
                          } else {
                            _this18.addNotesNote();
                          }
                        }
                      });
                      _context8.next = 12;
          ...
          value: function openPdf() {
            ...
            this.dataProvider.openPdf(planData).then(function (res) {
              ...
              _this19.dataProvider.openStudentReport(url).then(function (res) {
                _this19.dataProvider.hideLoading();
                ...
                if (res) {
                  ...
                  _this19.dataProvider.showToast('Unable to generate report');
                }
              })["catch"](function (e) {
                _this19.dataProvider.hideLoading();
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this20.router.navigate(['available-plan']);
                          }
                        }]
                      });
                    ...
                    case 0:
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          text: this.lang.exel,
                          handler: function handler() {
                            _this21.printReport('exel');
                          }
                        }, {
                          text: this.lang.pdf,
                          handler: function handler() {
                            _this21.printReport('pdf');
                          }
                        }]
                      });
          ...
          value: function printReport(type) {
            ...
            this.dataProvider.showLoading();
            this.dataProvider.openPdf(planData).then(function (res) {
              var course = _this22.navData; // this.courseInfo = course;

              var studentData = {
                // "date": this.dataProvider.getFormatedDate(this.dateSelected),
                "school_id": _this22.userDetails.details.school_id,
                "sid": _this22.navData.student_id,
                "report_type": type
              };

              if (type === "pdf") {
                var url = env.serverURL + 'student_report_new?school_id=' + studentData.school_id + '&sid=' + studentData.sid;

                _this22.dataProvider.openStudentReport(url).then(function (res) {
                  _this22.dataProvider.hideLoading();
                  ...
                  if (res) {
                    ...
                    _this22.printer.print(res.data, options).then(function (onSuccess) {}, function (e) {
                      console.log('printer.print', e);

                      _this22.dataProvider.showToast(_this22.lang.report_error);
                    });
                  } else {
                    _this22.dataProvider.showToast('Unable to generate report');
                  }
                })["catch"](function (e) {
                  _this22.dataProvider.hideLoading();
                ...
                _this22.dataProvider.getStudentReport(studentData).then(function (res) {
                  _this22.dataProvider.hideLoading();
              ...
              _this22.presentAlertPlanConfirm();
            });
          }
        }, {
          key: "presentAlertPlanConfirm",
          value: function presentAlertPlanConfirm() {
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this23.router.navigate(['available-plan']);
                          }
                        }]
                      });
      ...
      StudentDetailPage.ctorParameters = function () {
        return [{
          ...
          type: _ionic_native_printer_ngx__WEBPACK_IMPORTED_MODULE_17__["Printer"]
        }, {
