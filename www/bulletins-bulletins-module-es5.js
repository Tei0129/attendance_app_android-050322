(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["bulletins-bulletins-module"], {
    ...
    /***/
    function MlY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BulletinsPageRoutingModule", function () {
      ...
      var _bulletins_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./bulletins.page */
      "FC2f");
      ...
      var BulletinsPageRoutingModule = function BulletinsPageRoutingModule() {
        _classCallCheck(this, BulletinsPageRoutingModule);
      };

      BulletinsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function yTV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FC2f(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BulletinsPage", function () {
      ...
      var _raw_loader_bulletins_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./bulletins.page.html */
      "pQC2");
      /* harmony import */


      var _bulletins_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./bulletins.page.scss */
      "/yTV");
      /* harmony import */
      ...
      var _ionic_native_document_scanner_ngx___WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @ionic-native/document-scanner/ngx/ */
      "Vj9j");
      /* harmony import */


      var _service_document_document_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @ionic-native/file-opener/ngx */
      "te5A");
      /* harmony import */


      var _components_loader_loader_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ../components/loader/loader.component */
      "vPOg"); //import { TabsPage } from '../tabs/tabs';


      var BulletinsPage = /*#__PURE__*/function () {
        function BulletinsPage(navCtrl, dataProvider, authProvider, translate, alertCtrl, camera, network, photoViewer, route, router, documentService, documentScanner, zone, popoverController, fileOpener, platform) {
          var _this = this;

          _classCallCheck(this, BulletinsPage);
        ...
        _createClass(BulletinsPage, [{
          ...
          key: "addBulletin",
          value: function addBulletin(base64Image) {
            var objToSend = {
              queryParams: {
          ...
          key: "openBulletin",
          value: function openBulletin(bullet) {
            var _this2 = this;
            ...
            this.zone.run(function () {
              _this2.router.navigate(['view-bulletin'], navigation);
            });
          }
        }, {
          key: "getBulletins",
          value: function getBulletins() {
            ...
            this.presentPopover();
            this.dataProvider.getBulletins(data).then(function (res) {
              _this3.dissmissPopOver();

              if (res) {
                _this3.bulletins = res.data;

                if (_this3.bulletins) {
                  if (_this3.bulletins.length > 1) {
                    _this3.allBullentins = _this3.bulletins.splice(0, 20);
                  } else {
                    _this3.allBullentins = _this3.bulletins;
                  }

                  console.log(_this3.allBullentins);
                }
              }
            })["catch"](function (e) {
              _this3.dissmissPopOver();
          ...
          value: function shareBulletin(bullet) {
            ...
            this.zone.run(function () {
              _this4.router.navigate(['share-bulletins'], navigation);
            });
          }
        }, {
          key: "doInfinite",
          value: function doInfinite(infiniteScroll) {
            ...
            setTimeout(function () {
              _this5.allBullentins = _this5.allBullentins.concat(_this5.bulletins.splice(0, 20));
      ...
      BulletinsPage.ctorParameters = function () {
        return [{
      ...
      BulletinsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _service_data_data_service__WEBPACK_IMPORTED_MODULE_6__["DataService"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_8__["Camera"], _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_9__["Network"], _ionic_native_photo_viewer_ngx__WEBPACK_IMPORTED_MODULE_13__["PhotoViewer"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"], _service_document_document_service__WEBPACK_IMPORTED_MODULE_12__["DocumentService"], _ionic_native_document_scanner_ngx___WEBPACK_IMPORTED_MODULE_11__["DocumentScanner"], _angular_core__WEBPACK_IMPORTED_MODULE_3__["NgZone"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["PopoverController"], _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_14__["FileOpener"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"]])], BulletinsPage);
      /***/
    },
    ...
    function OU(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "BulletinsPageModule", function () {
      ...
      var _bulletins_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./bulletins-routing.module */
      "/MlY");
      /* harmony import */


      var _bulletins_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./bulletins.page */
      "FC2f");
      /* harmony import */
      ...
      var BulletinsPageModule = function BulletinsPageModule() {
        _classCallCheck(this, BulletinsPageModule);
      };

      BulletinsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _bulletins_routing_module__WEBPACK_IMPORTED_MODULE_5__["BulletinsPageRoutingModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"]],
    ...
    /***/
    function pQC2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=bulletins-bulletins-module-es5.js.map