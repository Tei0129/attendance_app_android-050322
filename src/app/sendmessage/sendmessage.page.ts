...
export class SendmessagePage implements OnInit {
 ...
 async selectUserpage(){
  ...
  sendMessage() {
    if (!this.mail.send_to.parents && !this.mail.send_to.mod && !this.mail.send_to.tech && !this.mail.send_to.others && !this.mail.send_to.admin && !this.mail.send_to.viewer && !this.mail.send_to.students) {
